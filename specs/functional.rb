...
describe 'Integration Tests' do
  ...
  after :each do
    # empty_equation_field(@browser.text_field(id: 'expression'),
    # flash_and_ensure_click(@browser.button(value: 'DEL')))

    @browser.close
    @browser = nil
    # why closing the browser each time?
    # The output field isn't cleared by repeatedly pressing the DEL button via
    # the automation. It does work manually, but Watir see
    # the 'expression' field empty after the first 'DEL press'
    # See for yourself, uncomment, the first two lines and comment
    # the close and nil statements
  end
  ...
  describe 'Functional Testing' do
    ...
    describe 'multiplications operations' do
      ...
      describe 'validating the multiplication of 1 positive anb 1 negative number' do
    ...
    describe 'Edge cases' do
      describe 'validating the division by 0 of any numbers' do
        it 'dividing any number ny 0 should yield an ERR result' do
          # ok, some fluff here. I could have used any static number here,
          # but hey, life's random at times. :-D
      ...
      describe 'Respecting the order of operations' do
        ...
        it 'Should respect the order or operation in a complex operation' do
          flash_and_ensure_click(@browser.button(value: '2'))
          flash_and_ensure_click(@browser.button(text: 'PLUS', class: 'operation'))
          flash_and_ensure_click(@browser.button(value: '2'))
          flash_and_ensure_click(@browser.button(text: 'MULT', class: 'operation'))
